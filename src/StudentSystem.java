...
public class StudentSystem {
    ...
    public static void StoreDetailsInFile ()
    {
        ...
        try {
            ...
            FileWriter file = new FileWriter("StudDetail.txt");
    ...
    public static void ViewTheStudList ()
    {
        ...
        for (int i = 0; i < registeredStud - 1; i++) {
            for (int j = 0; j < registeredStud - 1 - i; j++) {
                if (studDetails[j].getStudName().compareToIgnoreCase(studDetails[j + 1].getStudName()) > 0) {
        ...
        System.out.printf("+--------------------------------------+%n");
        for (int i = 0; i < registeredStud; i++) {
            System.out.printf("| %-20s  | %-12s |%n" ,studDetails[i].getStudName() , studDetails[i].getStudID());
            System.out.printf("----------------------------------------%n");
        }
    }
    ...
    public static void generateSummaryReport()
    {
        ...
        System.out.println("Total number of student registrations: " + registeredStud + " students.");
        ...
        if(registeredStud == 0){
            ...
            for (int i = 0; i < registeredStud - 1; i++) {
                for (int j = 0; j < registeredStud - i - 1; j++) {
                    if (studDetails[j + 1] != null && (studDetails[j] == null || studDetails[j].getAverageMarks() < studDetails[j + 1].getAverageMarks())) {
                        Student temp = studDetails[j];
                        studDetails[j] = studDetails[j + 1];
                        studDetails[j + 1] = temp;
                    }
            ...
            for (int i = 0; i < registeredStud; i++) {
                ...
                if (student != null) {
                    ...
                    System.out.printf("| %-8s  | %-25s | %-7s | %-7s | %-7s | %-6s | %-7s | %-12s |%n",
                            ...
                            student.getModules()[0].getModuleMarks(), student.getModules()[1].getModuleMarks(), student.getModules()[2].getModuleMarks(),
